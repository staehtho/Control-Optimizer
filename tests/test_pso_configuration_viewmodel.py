...
@pytest.mark.parametrize(
    ...
    [
        ("start_time", "startTimeChanged", 0.0, 0.5, 0.5, 1),
        ("start_time", "startTimeChanged", 0.0, 1.0, 0.0, 0),
        ("end_time", "endTimeChanged", 1.0, 1.5, 1.5, 1),
        ("end_time", "endTimeChanged", 1.0, 0.0, 1.0, 0),
