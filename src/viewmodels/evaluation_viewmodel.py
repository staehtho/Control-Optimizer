...
class EvaluationViewModel(BaseViewModel):
    ...
    plant_num = BaseViewModel._logged_property(
        attribute="_pso_snapshot.plant_num",
        property_type=list,
        read_only=True
    )

    plant_den = BaseViewModel._logged_property(
        attribute="_pso_snapshot.plant_den",
        property_type=list,
        read_only=True
    )
    ...
    controller_anti_windup = BaseViewModel._logged_property(
        attribute="_pso_snapshot.controller_anti_windup",
